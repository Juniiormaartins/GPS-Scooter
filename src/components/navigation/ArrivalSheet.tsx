    ...
    <>
      ...
      */}
      ...
      <div
        ...
        className={`pointer-events-auto absolute inset-x-3 bottom-0 z-50 rounded-t-2xl bg-surface-card px-card pb-[max(1.25rem,var(--safe-bottom))] pt-6 shadow-sheet transition-all duration-slow ease-ease-out-soft ${
